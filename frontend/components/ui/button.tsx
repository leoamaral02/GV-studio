...
const buttonVariants = cva(
  "inline-flex h-10 items-center justify-center gap-2 rounded-lg px-4 text-sm font-semibold transition disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-gold text-black hover:bg-[#d7bb83]",
        secondary: "border border-border bg-elevated text-text hover:border-gold-mid",
        ghost: "text-muted hover:bg-elevated hover:text-text",
        danger: "bg-danger-soft text-danger hover:bg-[#F0707028]"
      },
      size: {
        default: "h-10 px-4",
        sm: "h-8 px-3 text-xs",
